...
class poseEstimation():
    def __init__(self, static_image_mode=False, upper_body_only=False, modelComplexity=1, smooth_landmarks=True, min_detection_confidence=0.5, min_tracking_confidence=0.5):
